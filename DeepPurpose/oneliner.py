...
# below added by YS 5Feb2022
def virtual_screening_BDB320k_r1(target, X_repurpose = None,
					target_name = None, 
					drug_names = None,
					train_drug = None, 
					train_target = None, 
	...
	pretrained_model_names = [['CNN','CNN'], ['Morgan', 'CNN'], ['Daylight', 'AAC'], ['Transformer', 'CNN'], ['ESPF', 'ESPF'], ['Morgan', 'AAC']]
